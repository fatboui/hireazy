        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-white transition-colors" title="Visit our Twitter page">
                <Twitter className="h-5 w-5" />
              </a>
              <a href="https://www.linkedin.com/company/hireazy-pvt-ltd/" className="text-gray-400 hover:text-white transition-colors" title="Visit our LinkedIn page">
